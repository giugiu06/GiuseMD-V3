...
// Nel tuo main.js o index.js, all'inizio del file
import './lib/slotDB.js'; // Assicurati che il percorso sia corretto rispetto al tuo main.js

// ... il resto del tuo codice di avvio del bot (client Baileys, handler messaggi, ecc.)
...
mobile: MethodMobile,
browser: opcion == '1' ? ['GiuseMD-V3', 'Safari', '3.0.0'] : methodCodeQR ? ['GiuseMD-V3', 'Safari', '3.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `✅ GiuseMD-V3 è online da: ✈︎ ${uptime} 🌕︎ .𝐦𝐞𝐧𝐮 ☀ .𝐢𝐧𝐟𝐨 🌙 .𝐩𝐢𝐧𝐠︎ 💤︎`
